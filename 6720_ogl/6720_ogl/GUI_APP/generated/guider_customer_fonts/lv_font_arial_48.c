...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 512, .box_w = 34, .box_h = 35, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 595, .adv_w = 512, .box_w = 32, .box_h = 35, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1155, .adv_w = 725, .box_w = 45, .box_h = 35, .ofs_x = 0, .ofs_y = 0}
};
